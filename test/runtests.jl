...
@testset "SparseMatrixVBCs" begin
    ...
    for A in [
        ...
        for method in [
            ...
            DynamicTotalChunker(ConstrainedCost(model_SparseMatrix1DVBC_blocks(), VertexCount(), 4)),
            DynamicTotalChunker(ConstrainedCost(model_SparseMatrix1DVBC_memory(Float64, Int), VertexCount(), 4)),
